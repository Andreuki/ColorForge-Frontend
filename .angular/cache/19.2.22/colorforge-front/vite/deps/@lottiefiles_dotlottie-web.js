...
function r(e5, t2, r2) {
  return (t2 = n(t2)) in e5 ? Object.defineProperty(e5, t2, {
    value: r2,
    enumerable: true,
    configurable: true,
    writable: true
...
var f;
var p = typeof TextDecoder < `u` ? new TextDecoder(`utf-8`, {
  ignoreBOM: true,
  fatal: true
}) : {
  decode: () => {
...
var v = 0;
var y = typeof TextEncoder < `u` ? new TextEncoder(`utf-8`) : {
  encode: () => {
...
var j = class {
  ...
  has_segment() {
    return f.dotlottieplayerwasm_has_segment(this.__wbg_ptr) !== 0;
  }
  is_complete() {
  ...
  request_frame() {
    return f.dotlottieplayerwasm_request_frame(this.__wbg_ptr);
  }
  segment_start() {
  ...
  get_layer_bounds(e5) {
    let t2 = x(e5, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), n2 = v;
    return f.dotlottieplayerwasm_get_layer_bounds(this.__wbg_ptr, t2, n2);
  }
  get_pixel_buffer() {
    return f.dotlottieplayerwasm_get_pixel_buffer(this.__wbg_ptr);
  }
  segment_duration() {
    return f.dotlottieplayerwasm_segment_duration(this.__wbg_ptr);
  }
  set_audio_volume(e5) {
  ...
  constructor() {
    return this.__wbg_ptr = f.dotlottieplayerwasm_new() >>> 0, A.register(this, this.__wbg_ptr, this), this;
  }
  mode() {
  ...
  seek(e5) {
    return f.dotlottieplayerwasm_seek(this.__wbg_ptr, e5) !== 0;
  }
  stop() {
    return f.dotlottieplayerwasm_stop(this.__wbg_ptr) !== 0;
  }
  tick() {
    return f.dotlottieplayerwasm_tick(this.__wbg_ptr) !== 0;
  }
  clear() {
    f.dotlottieplayerwasm_clear(this.__wbg_ptr);
  }
  pause() {
  ...
  sm_tick() {
    return f.dotlottieplayerwasm_sm_tick(this.__wbg_ptr) !== 0;
  }
  autoplay() {
  ...
  intersect(e5, t2, n2) {
    let r2 = x(n2, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), i2 = v;
    return f.dotlottieplayerwasm_intersect(this.__wbg_ptr, e5, t2, r2, i2) !== 0;
  }
  is_loaded() {
  ...
  return __async(this, null, function* () {
    if (typeof Response == `function` && e5 instanceof Response) {
      if (typeof WebAssembly.instantiateStreaming == `function`) try {
        return yield WebAssembly.instantiateStreaming(e5, t2);
      } catch (t3) {
      ...
      let n2 = yield e5.arrayBuffer();
      return yield WebAssembly.instantiate(n2, t2);
    } else {
      let n2 = yield WebAssembly.instantiate(e5, t2);
...
function N() {
  ...
  }, e5.wbg.__wbg_now_807e54c39636c349 = function() {
    return Date.now();
...
function F(e5) {
  return __async(this, null, function* () {
    ...
    if (e5 !== void 0 && (Object.getPrototypeOf(e5) === Object.prototype ? {
      module_or_path: e5
    } = e5 : console.warn(`using deprecated parameters for the initialization function; pass a single object instead`)), e5 === void 0) throw Error(`WASM module URL must be provided via DotLottieWasmLoader or setWasmUrl().`);
    let t2 = N();
...
function G(e5) {
  ...
  if (t2 instanceof HTMLCanvasElement) {
    ...
    return !Number.isFinite(a2) || !Number.isFinite(o2) || Number.isNaN(a2) || Number.isNaN(o2) ? null : {
      x: a2,
      y: o2
    };
  }
...
function q(e5, t2, n2) {
  ...
  return {
    load() {
      return r2 || (r2 = e5({
        module_or_path: i2
      }).then(() => void 0).catch((t3) => __async(null, null, function* () {
        console.warn(`Primary WASM load failed from ${i2}: ${t3.message}`), console.warn(`Attempting to load WASM from backup URL: ${n2}`);
        try {
          yield e5({
            module_or_path: n2
          });
        } catch (e6) {
          throw console.error(`Primary WASM URL failed: ${t3.message}`), console.error(`Backup WASM URL failed: ${e6.message}`), r2 = null, Error(`WASM loading failed from all sources.`);
        }
      }))), r2;
    },
    setWasmUrl(e6) {
...
var J = q(F, `https://cdn.jsdelivr.net/npm/${d}@${u}/dist/dotlottie-player.wasm`, `https://unpkg.com/${d}@${u}/dist/dotlottie-player.wasm`);
var Y = (e5) => {
  switch (e5) {
    case `reverse`:
      return k.Reverse;
...
var ae = class {
  constructor(e5) {
    r(this, `_canvas`, null), r(this, `_pendingLoad`, null), r(this, `_context`, null), r(this, `_eventManager`, void 0), r(this, `_animationFrameId`, null), r(this, `_frameManager`, void 0), r(this, `_dotLottieCore`, null), r(this, `_stateMachineId`, ``), r(this, `_stateMachineConfig`, null), r(this, `_isStateMachineRunning`, false), r(this, `_renderConfig`, {}), r(this, `_isFrozen`, false), r(this, `_backgroundColor`, null), r(this, `_boundOnClick`, null), r(this, `_boundOnPointerUp`, null), r(this, `_boundOnPointerDown`, null), r(this, `_boundOnPointerMove`, null), r(this, `_boundOnPointerEnter`, null), r(this, `_boundOnPointerLeave`, null), r(this, `_bufferMismatchCount`, 0), r(this, `_lastExpectedBufferSize`, 0), r(this, `_marker`, ``), this._canvas = e5.canvas ?? null, this._eventManager = new I(), this._frameManager = new o(), this._renderConfig = __spreadProps(__spreadValues({}, e5.renderConfig), {
      devicePixelRatio: e5.renderConfig?.devicePixelRatio || U(),
      freezeOnOffscreen: e5.renderConfig?.freezeOnOffscreen ?? true
    }), this._initWasm().then(() => {
      this._dotLottieCore = this._createCore(), this._dotLottieCore.set_autoplay(e5.autoplay ?? false), this._dotLottieCore.set_loop(e5.loop ?? false), this._dotLottieCore.set_loop_count(e5.loopCount ?? 0), this._dotLottieCore.set_mode(Y(e5.mode ?? `forward`)), this._dotLottieCore.set_speed(e5.speed ?? 1), this._dotLottieCore.set_use_frame_interpolation(e5.useFrameInterpolation ?? true), e5.segment && e5.segment.length === 2 && this._dotLottieCore.set_segment(e5.segment[0], e5.segment[1]), this._marker = e5.marker ?? ``, this._marker && this._dotLottieCore.set_marker(this._marker), this._dotLottieCore.set_layout(e5.layout?.fit ?? `contain`, e5.layout?.align?.[0] ?? 0.5, e5.layout?.align?.[1] ?? 0.5), this._stateMachineId = e5.stateMachineId ?? ``, this._stateMachineConfig = e5.stateMachineConfig ?? null, this._onCoreCreated(), this._eventManager.dispatch({
        type: `ready`
      }), e5.data ? this._canvas ? this._loadFromData(e5.data) : this._pendingLoad = {
        data: e5.data
      } : e5.src && (this._canvas ? this._loadFromSrc(e5.src) : this._pendingLoad = {
        src: e5.src
      }), e5.backgroundColor && this.setBackgroundColor(e5.backgroundColor);
    }).catch((e6) => {
      console.error(`[dotlottie-web] Initialization failed:`, e6), this._eventManager.dispatch({
        type: `loadError`,
        error: Error(`Failed to load wasm module: ${e6}`)
      });
    });
  }
  _initWasm() {
  ...
  _drainPlayerEvents() {
    ...
    let e5;
    for (; (e5 = this._dotLottieCore.poll_event()) != null; ) {
      let t2 = e5;
      switch (t2.type) {
        case `Load`:
  ...
  _drainSmEvents() {
    ...
    for (; (e5 = this._dotLottieCore.sm_poll_event()) != null; ) {
      ...
      switch (t3.type) {
        case `Start`:
          setTimeout(() => {
            this._isStateMachineRunning = true, this._eventManager.dispatch({
        ...
        case `Stop`:
          setTimeout(() => {
            this._isStateMachineRunning = false, this._eventManager.dispatch({
        ...
        case `BooleanInputChange`:
          this._eventManager.dispatch({
            ...
            inputName: t3.name ?? ``,
            newValue: t3.newValue,
            oldValue: t3.oldValue
          });
          break;
    ...
    for (; (t2 = this._dotLottieCore.sm_poll_internal_event()) != null; ) {
      ...
      if (e6.type === `Message`) {
        let t3 = e6.message ?? ``;
        s && t3.startsWith(`OpenUrl: `) ? K(t3) : this._eventManager.dispatch({
  ...
  _dispatchError(e5) {
    console.error(e5), this._eventManager.dispatch({
      type: `loadError`,
      error: Error(e5)
    });
  }
  _fetchData(e5) {
    return __async(this, null, function* () {
      let t2 = yield fetch(e5);
      if (!t2.ok) throw Error(`Failed to fetch animation data from URL: ${e5}. ${t2.status}: ${t2.statusText}`);
      let n2 = yield t2.arrayBuffer();
      return B(n2) ? n2 : new TextDecoder().decode(n2);
    });
  }
  _loadFromData(e5) {
    ...
    r2 ? (this._renderConfig.quality !== void 0 && this._dotLottieCore.set_quality(this._renderConfig.quality), s && this.resize(), this._drainPlayerEvents(), this._marker && this._dotLottieCore.set_marker(this._marker), setTimeout(() => {
      this._eventManager.dispatch({
        type: `frame`,
        currentFrame: this.currentFrame
      });
    }, 0), this._dotLottieCore.render(), this._drainPlayerEvents(), this._draw(), this._stateMachineId ? this.stateMachineLoad(this._stateMachineId) && this.stateMachineStart() && this._startAnimationLoop() : this._dotLottieCore.is_playing() && this._startAnimationLoop(), s && this._canvas instanceof HTMLCanvasElement && (this._renderConfig.freezeOnOffscreen && (L.observe(this._canvas, this), W(this._canvas) || this.freeze()), this._renderConfig.autoResize && R.observe(this._canvas, this))) : this._drainPlayerEvents();
  }
  _loadFromSrc(e5) {
  ...
  get layout() {
    if (this._dotLottieCore) return {
      ...
      fit: X(this._dotLottieCore.layout_fit())
    };
  }
  get marker() {
  ...
  get segment() {
    if (!(!this._dotLottieCore || !this._dotLottieCore.has_segment())) return [this._dotLottieCore.segment_start(), this._dotLottieCore.segment_end()];
  }
  get loop() {
    return this._dotLottieCore?.loop_animation() ?? false;
  }
  get mode() {
    return this._dotLottieCore ? ie(this._dotLottieCore.mode()) : `forward`;
  }
  get isFrozen() {
  ...
  load(e5) {
    this._dotLottieCore !== null && (this._stopAnimationLoop(), this._cleanupCanvas(), this._isFrozen = false, this._dotLottieCore.set_autoplay(e5.autoplay ?? false), this._dotLottieCore.set_loop(e5.loop ?? false), this._dotLottieCore.set_loop_count(e5.loopCount ?? 0), this._dotLottieCore.set_mode(Y(e5.mode ?? `forward`)), this._dotLottieCore.set_speed(e5.speed ?? 1), this._dotLottieCore.set_use_frame_interpolation(e5.useFrameInterpolation ?? true), e5.segment && e5.segment.length === 2 ? this._dotLottieCore.set_segment(e5.segment[0], e5.segment[1]) : this._dotLottieCore.clear_segment(), this._marker = e5.marker ?? ``, this._marker ? this._dotLottieCore.set_marker(this._marker) : this._dotLottieCore.clear_marker(), this._dotLottieCore.set_layout(e5.layout?.fit ?? `contain`, e5.layout?.align?.[0] ?? 0.5, e5.layout?.align?.[1] ?? 0.5), e5.data ? this._canvas ? this._loadFromData(e5.data) : this._pendingLoad = {
      data: e5.data
    } : e5.src && (this._canvas ? this._loadFromSrc(e5.src) : this._pendingLoad = {
      src: e5.src
    }), e5.backgroundColor && this.setBackgroundColor(e5.backgroundColor));
  ...
  _draw() {
    if (!(this._dotLottieCore === null || this._canvas === null) && (!this._context && `getContext` in this._canvas && typeof this._canvas.getContext == `function` && (typeof HTMLCanvasElement < `u` && this._canvas instanceof HTMLCanvasElement || typeof OffscreenCanvas < `u` && this._canvas instanceof OffscreenCanvas) && (this._context = this._canvas.getContext(`2d`)), this._context)) {
      let e5 = this._dotLottieCore.get_pixel_buffer(), t2 = this._canvas.width * this._canvas.height * 4;
      if (e5.byteLength !== t2) {
        this._lastExpectedBufferSize === t2 ? this._bufferMismatchCount += 1 : (this._bufferMismatchCount = 1, this._lastExpectedBufferSize = t2), this._bufferMismatchCount === 10 && console.warn(`[dotlottie-web] Persistent buffer size mismatch detected. Expected ${t2} bytes for canvas ${this._canvas.width}x${this._canvas.height}, but got ${e5.byteLength} bytes. This may indicate a WASM memory allocation issue or invalid canvas dimensions.`);
        return;
      }
      this._bufferMismatchCount = 0, this._lastExpectedBufferSize = t2;
      let n2 = null, r2 = new Uint8ClampedArray(e5.buffer, e5.byteOffset, e5.byteLength);
      typeof ImageData > `u` ? (n2 = this._context.createImageData(this._canvas.width, this._canvas.height), n2.data.set(r2)) : n2 = new ImageData(r2, this._canvas.width, this._canvas.height), this._context.putImageData(n2, 0, 0);
    }
  }
  _cleanupCanvas() {
  ...
  _stopAnimationLoop() {
    this._animationFrameId !== null && (this._frameManager.cancelAnimationFrame(this._animationFrameId), this._animationFrameId = null);
  }
  _startAnimationLoop() {
    this._animationFrameId === null && this._dotLottieCore && !this._isFrozen && (this._dotLottieCore.is_playing() || this._isStateMachineRunning) && (this._animationFrameId = this._frameManager.requestAnimationFrame(this._animationLoop.bind(this)));
  }
  _animationLoop() {
    ...
    try {
      let e5 = this._isStateMachineRunning ? this._dotLottieCore.sm_tick() : this._dotLottieCore.tick();
      this._isStateMachineRunning ? this._drainSmEvents() : this._drainPlayerEvents(), e5 && this._draw(), this._animationFrameId = this._frameManager.requestAnimationFrame(this._animationLoop.bind(this));
    } catch (e5) {
      console.error(`Error in animation frame:`, e5), this._eventManager.dispatch({
        type: `renderError`,
        error: e5
      }), e5 instanceof WebAssembly.RuntimeError && this.destroy();
    }
  }
  play() {
    ...
    this._drainPlayerEvents(), (e5 || this._dotLottieCore.is_playing()) && (this._isFrozen = false, this._startAnimationLoop()), this._canvas && s && this._canvas instanceof HTMLCanvasElement && this._renderConfig.freezeOnOffscreen && !W(this._canvas) && this.freeze();
  }
  pause() {
  ...
  stop() {
    ...
    this._drainPlayerEvents(), this._stopAnimationLoop(), e5 && (this._eventManager.dispatch({
      type: `frame`,
      currentFrame: this.currentFrame
    }), this._dotLottieCore.render(), this._draw());
  }
  setFrame(e5) {
    if (this._dotLottieCore !== null && this._dotLottieCore.seek(e5)) {
  ...
  destroy() {
    this._stopAnimationLoop(), this._isStateMachineRunning = false, this._cleanupCanvas(), this._dotLottieCore?.free(), this._dotLottieCore = null, this._context = null, this._eventManager.dispatch({
      type: `destroy`
    }), this._eventManager.removeAllEventListeners(), this._cleanupStateMachineListeners();
  }
  freeze() {
    this._animationFrameId !== null && (this._stopAnimationLoop(), this._isFrozen = true, this._eventManager.dispatch({
      type: `freeze`
    }));
  }
  unfreeze() {
    this._animationFrameId === null && (this._isFrozen = false, this._eventManager.dispatch({
      type: `unfreeze`
    }), this._startAnimationLoop());
  }
  resize() {
    if (!(!this._dotLottieCore || !this.isLoaded || !this._canvas)) {
      if (s && this._canvas instanceof HTMLCanvasElement) {
        let e5 = this._renderConfig.devicePixelRatio || window.devicePixelRatio || 1, {
          height: t2,
          width: n2
  ...
  setSegment(e5, t2) {
    this._dotLottieCore !== null && this._dotLottieCore.set_segment(e5, t2);
  }
  setMode(e5) {
    this._dotLottieCore !== null && this._dotLottieCore.set_mode(Y(e5));
  }
  setRenderConfig(e5) {
    let _a = e5, {
      devicePixelRatio: t2,
      freezeOnOffscreen: n2,
      quality: r2
    } = _a, i2 = __objRest(_a, [
      "devicePixelRatio",
      "freezeOnOffscreen",
    ...
    this._renderConfig = __spreadValues(__spreadProps(__spreadValues(__spreadValues({}, this._renderConfig), i2), {
      devicePixelRatio: t2 || U(),
      freezeOnOffscreen: n2 ?? true
    }), r2 !== void 0 && {
      quality: r2
    }), r2 !== void 0 && this._dotLottieCore && this._dotLottieCore.set_quality(r2), s && this._canvas instanceof HTMLCanvasElement && (this._renderConfig.autoResize ? R.observe(this._canvas, this) : R.unobserve(this._canvas), this._renderConfig.freezeOnOffscreen ? (L.observe(this._canvas, this), W(this._canvas) || this.freeze()) : (L.unobserve(this._canvas), this._isFrozen && this.unfreeze()));
  }
  loadAnimation(e5) {
  ...
  setMarker(e5) {
    this._dotLottieCore !== null && (this._marker = e5, this._dotLottieCore.set_marker(e5));
  }
  markers() {
  ...
  setColorSlot(e5, t2) {
    if (this._dotLottieCore === null) return false;
    let n2 = this._isKeyframeArray(t2), r2 = JSON.stringify({
      a: n2 ? 1 : 0,
      k: t2
    }), i2 = this._dotLottieCore.set_slot_str(e5, r2);
    return this._dotLottieCore.render(), this._draw(), i2;
  }
  setScalarSlot(e5, t2) {
    if (this._dotLottieCore === null) return false;
    let n2 = typeof t2 != `number`, r2 = JSON.stringify({
      a: n2 ? 1 : 0,
      k: t2
    }), i2 = this._dotLottieCore.set_slot_str(e5, r2);
    return this._dotLottieCore.render(), this._draw(), i2;
  ...
  setGradientSlot(e5, t2, n2) {
    if (this._dotLottieCore === null) return false;
    let r2 = this._isKeyframeArray(t2), i2 = JSON.stringify({
      k: {
        a: r2 ? 1 : 0,
        k: t2
      },
      p: n2
    }), a2 = this._dotLottieCore.set_slot_str(e5, i2);
  ...
  setTextSlot(e5, t2) {
    ...
    if (n2) {
      ...
      if (e6 && `k` in e6 && Array.isArray(e6.k)) {
        let n3 = e6.k[0];
        `s` in n3 && typeof n3.s == `object` && (r2 = __spreadValues(__spreadValues({}, n3.s), t2));
      }
    }
    let i2 = JSON.stringify({
      a: 0,
      k: [{
        t: 0,
        s: r2
  ...
  getLayerBoundingBox(e5) {
    let t2 = this._dotLottieCore?.get_layer_bounds(e5);
    if (t2 && t2.length === 8) return Array.from(t2);
  }
  static transformThemeToLottieSlots(e5, t2) {
    return ``;
  }
  stateMachineLoad(e5) {
...
var se = class {
  ...
  terminateWorker(e5) {
    ...
    t2 && (t2.terminate(), this._workers.delete(e5));
  }
};
function Z(e5, t2) {
...
var $ = class e4 {
  constructor(t2) {
    if (r(this, `_eventManager`, new I()), r(this, `_id`, void 0), r(this, `_worker`, void 0), r(this, `_canvas`, void 0), r(this, `_dotLottieInstanceState`, {
      ...
      isReady: false,
      manifest: null
    }), r(this, `_created`, false), r(this, `_boundOnClick`, null), r(this, `_boundOnPointerUp`, null), r(this, `_boundOnPointerDown`, null), r(this, `_boundOnPointerMove`, null), r(this, `_boundOnPointerEnter`, null), r(this, `_boundOnPointerLeave`, null), r(this, `_pendingConfig`, null), t2.canvas) {
    ...
    this._worker = e4._workerManager.getWorker(n2), e4._workerManager.assignAnimationToWorker(this._id, n2), e4._wasmUrl && this._sendMessage(`setWasmUrl`, {
      url: e4._wasmUrl
    });
    let i2 = __spreadProps(__spreadValues({}, t2), {
      renderConfig: __spreadProps(__spreadValues({}, t2.renderConfig), {
        devicePixelRatio: t2.renderConfig?.devicePixelRatio || U(),
        freezeOnOffscreen: t2.renderConfig?.freezeOnOffscreen ?? true
      })
    });
    this._pendingConfig = i2, this._canvas && (this._create(i2), this._pendingConfig = null), this._worker.addEventListener(`message`, this._handleWorkerEvent.bind(this));
  }
  _handleWorkerEvent(e5) {
    return __async(this, null, function* () {
      let t2 = e5.data;
      if (!t2.id && (t2.method === `onLoad` && t2.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(t2.result.event), s && this._canvas instanceof HTMLCanvasElement && (this._dotLottieInstanceState.renderConfig.freezeOnOffscreen && (L.observe(this._canvas, this), W(this._canvas) || (yield this.freeze())), this._dotLottieInstanceState.renderConfig.autoResize && R.observe(this._canvas, this))), t2.method === `onComplete` && t2.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(t2.result.event)), t2.method === `onDestroy` && t2.result.instanceId === this._id && this._eventManager.dispatch(t2.result.event), t2.method === `onUnfreeze` && t2.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._dotLottieInstanceState.isFrozen = false, this._eventManager.dispatch(t2.result.event)), t2.method === `onFrame` && t2.result.instanceId === this._id && (this._dotLottieInstanceState.currentFrame = t2.result.event.currentFrame, this._eventManager.dispatch(t2.result.event)), t2.method === `onRender` && t2.result.instanceId === this._id && this._eventManager.dispatch(t2.result.event), t2.method === `onFreeze` && t2.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(t2.result.event)), t2.method === `onPause` && t2.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(t2.result.event)), t2.method === `onPlay` && t2.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(t2.result.event)), t2.method === `onStop` && t2.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(t2.result.event)), t2.method === `onLoadError` && t2.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(t2.result.event)), t2.method === `onRenderError` && t2.result.instanceId === this._id && this._eventManager.dispatch(t2.result.event), t2.method === `onReady` && t2.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(t2.result.event)), t2.method === `onLoop` && t2.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(t2.result.event)), t2.method === `onStateMachineStart` && t2.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._setupStateMachineListeners(), this._eventManager.dispatch(t2.result.event)), t2.method === `onStateMachineStop` && t2.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._cleanupStateMachineListeners(), this._eventManager.dispatch(t2.result.event)), t2.method === `onStateMachineTransition` && t2.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(t2.result.event)), t2.method === `onStateMachineStateEntered` && t2.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(t2.result.event)), t2.method === `onStateMachineStateExit` && t2.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(t2.result.event)), t2.method === `onStateMachineCustomEvent` && t2.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(t2.result.event)), t2.method === `onStateMachineError` && t2.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(t2.result.event)), t2.method === `onStateMachineBooleanInputValueChange` && t2.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(t2.result.event)), t2.method === `onStateMachineNumericInputValueChange` && t2.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(t2.result.event)), t2.method === `onStateMachineStringInputValueChange` && t2.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(t2.result.event)), t2.method === `onStateMachineInputFired` && t2.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(t2.result.event)), t2.method === `onStateMachineInternalMessage` && t2.result.instanceId === this._id)) {
        yield this._updateDotLottieInstanceState();
        let e6 = t2.result.event;
        e6.message.startsWith(`OpenUrl: `) && K(e6.message);
      }
    });
  }
  _create(e5) {
    return __async(this, null, function* () {
      ...
      let {
        instanceId: n2
      } = yield this._sendMessage(`create`, __spreadValues({
        instanceId: this._id,
        config: __spreadProps(__spreadValues({}, e5), {
          canvas: t2
        })
      }, Z(this._canvas, e5.renderConfig?.devicePixelRatio || U())), [t2]);
  ...
  setCanvas(e5) {
    return __async(this, null, function* () {
      ...
      if (this._canvas !== e5) {
        ...
        this._canvas = e5, !this._created && this._pendingConfig && (yield this._create(this._pendingConfig), this._pendingConfig = null);
      }
    });
  }
  get autoplay() {
  ...
  play() {
    return __async(this, null, function* () {
      this._created && (yield this._sendMessage(`play`, {
        instanceId: this._id
      }), yield this._updateDotLottieInstanceState(), s && this._canvas instanceof HTMLCanvasElement && this._dotLottieInstanceState.renderConfig.freezeOnOffscreen && !W(this._canvas) && (yield this.freeze()));
    });
  }
  pause() {
    return __async(this, null, function* () {
  ...
  setRenderConfig(e5) {
    return __async(this, null, function* () {
      ...
      yield this._sendMessage(`setRenderConfig`, {
        instanceId: this._id,
        renderConfig: __spreadValues(__spreadProps(__spreadValues(__spreadValues({}, this._dotLottieInstanceState.renderConfig), i2), {
          devicePixelRatio: t2 || U(),
          freezeOnOffscreen: n2 ?? true
        }), r2 !== void 0 && {
          quality: r2
        })
      }), yield this._updateDotLottieInstanceState(), s && this._canvas instanceof HTMLCanvasElement && (this._dotLottieInstanceState.renderConfig.autoResize ? R.observe(this._canvas, this) : R.unobserve(this._canvas), this._dotLottieInstanceState.renderConfig.freezeOnOffscreen ? (L.observe(this._canvas, this), W(this._canvas) || (yield this.freeze())) : (L.unobserve(this._canvas), this._dotLottieInstanceState.isFrozen && (yield this.unfreeze())));
    });
  }
  setUseFrameInterpolation(e5) {
    return __async(this, null, function* () {
  ...
  setTheme(e5) {
    return __async(this, null, function* () {
      ...
      let t2 = this._sendMessage(`setTheme`, {
        instanceId: this._id,
        themeId: e5
      });
      return yield this._updateDotLottieInstanceState(), t2;
    });
  }
  load(e5) {
    return __async(this, null, function* () {
      if (!this._created) {
        this._pendingConfig && (this._pendingConfig = __spreadValues(__spreadValues({}, this._pendingConfig), e5));
        return;
      }
      yield this._sendMessage(`load`, {
        config: e5,
        instanceId: this._id
      }), yield this._updateDotLottieInstanceState();
    });
  ...
  setLoopCount(e5) {
    return __async(this, null, function* () {
      this._created && (yield this._sendMessage(`setLoopCount`, {
        instanceId: this._id,
        loopCount: e5
      }), yield this._updateDotLottieInstanceState());
    });
  ...
  resize() {
    return __async(this, null, function* () {
      ...
      let {
        height: e5,
        width: t2
      } = Z(this._canvas, this._dotLottieInstanceState.renderConfig.devicePixelRatio || U());
  ...
  destroy() {
    return __async(this, null, function* () {
      this._created && (this._created = false, yield this._sendMessage(`destroy`, {
        instanceId: this._id
      }), this._cleanupStateMachineListeners(), e4._workerManager.unassignAnimationFromWorker(this._id), this._eventManager.removeAllEventListeners(), s && this._canvas instanceof HTMLCanvasElement && (L.unobserve(this._canvas), R.unobserve(this._canvas)));
    });
  }
  freeze() {
    return __async(this, null, function* () {
  ...
  setSlots(e5) {
    return __async(this, null, function* () {
      this._created && (yield this._sendMessage(`setSlots`, {
        instanceId: this._id,
        slots: e5
      }));
    });
  ...
  getSlotIds() {
    return __async(this, null, function* () {
      return this._created ? this._sendMessage(`getSlotIds`, {
        instanceId: this._id
      }) : [];
    });
  }
  getSlotType(e5) {
    return __async(this, null, function* () {
      if (this._created) return this._sendMessage(`getSlotType`, {
        instanceId: this._id,
        slotId: e5
      });
    });
  ...
  getSlot(e5) {
    return __async(this, null, function* () {
      if (this._created) return this._sendMessage(`getSlot`, {
        instanceId: this._id,
        slotId: e5
      });
    });
  ...
  getSlots() {
    return __async(this, null, function* () {
      return this._created ? this._sendMessage(`getSlots`, {
        instanceId: this._id
      }) : {};
    });
  }
  setColorSlot(e5, t2) {
    return __async(this, null, function* () {
      return this._created ? this._sendMessage(`setColorSlot`, {
        instanceId: this._id,
        slotId: e5,
        value: t2
      }) : false;
  ...
  setScalarSlot(e5, t2) {
    return __async(this, null, function* () {
      return this._created ? this._sendMessage(`setScalarSlot`, {
        instanceId: this._id,
        slotId: e5,
        value: t2
      }) : false;
  ...
  setVectorSlot(e5, t2) {
    return __async(this, null, function* () {
      return this._created ? this._sendMessage(`setVectorSlot`, {
        instanceId: this._id,
        slotId: e5,
        value: t2
      }) : false;
  ...
  setGradientSlot(e5, t2, n2) {
    return __async(this, null, function* () {
      return this._created ? this._sendMessage(`setGradientSlot`, {
        instanceId: this._id,
        slotId: e5,
        value: t2,
        colorStopCount: n2
  ...
  setTextSlot(e5, t2) {
    return __async(this, null, function* () {
      return this._created ? this._sendMessage(`setTextSlot`, {
        instanceId: this._id,
        slotId: e5,
        value: t2
      }) : false;
  ...
  resetSlot(e5) {
    return __async(this, null, function* () {
      return this._created ? this._sendMessage(`resetSlot`, {
        instanceId: this._id,
        slotId: e5
      }) : false;
    });
  ...
  clearSlot(e5) {
    return __async(this, null, function* () {
      return this._created ? this._sendMessage(`clearSlot`, {
        instanceId: this._id,
        slotId: e5
      }) : false;
    });
  ...
  resetSlots() {
    return __async(this, null, function* () {
      return this._created ? this._sendMessage(`resetSlots`, {
        instanceId: this._id
      }) : false;
    });
  }
  clearSlots() {
    return __async(this, null, function* () {
      return this._created ? this._sendMessage(`clearSlots`, {
        instanceId: this._id
      }) : false;
    });
  }
  _updateDotLottieInstanceState() {
    return __async(this, null, function* () {
      this._created && (this._dotLottieInstanceState = (yield this._sendMessage(`getDotLottieInstanceState`, {
        instanceId: this._id
      })).state);
    });
  }
  ...
  setThemeData(e5) {
    return __async(this, null, function* () {
      if (!this._created) return false;
      let t2 = yield this._sendMessage(`setThemeData`, {
        instanceId: this._id,
        themeData: e5
      });
      return yield this._updateDotLottieInstanceState(), t2;
  ...
  setTransform(e5) {
    return __async(this, null, function* () {
      return this._created ? this._sendMessage(`setTransform`, {
        instanceId: this._id,
        transform: e5
      }) : false;
    });
  ...
  getTransform() {
    return __async(this, null, function* () {
      if (this._created) return this._sendMessage(`getTransform`, {
        instanceId: this._id
      });
    });
  }
  _sendMessage(e5, t2, n2) {
    return __async(this, null, function* () {
      let r2 = {
        id: `dotlottie-request-${Q()}`,
        method: e5,
        params: t2
      };
      return this._worker.postMessage(r2, n2 || []), new Promise((t3, n3) => {
        let i2 = (a2) => {
          let o2 = a2.data;
          o2.id === r2.id && (this._worker.removeEventListener(`message`, i2), o2.error ? n3(Error(`Failed to execute method ${e5}: ${o2.error}`)) : t3(o2.result));
        };
        this._worker.addEventListener(`message`, i2);
      });
    });
  }
  addEventListener(e5, t2) {
  ...
  static registerFont(t2, n2) {
    return __async(this, null, function* () {
      try {
        let r2 = Q();
        return e4._workerManager.broadcastMessage({
          id: r2,
          method: `registerFont`,
          params: {
            fontName: t2,
  ...
  stateMachineLoad(e5) {
    return __async(this, null, function* () {
      if (!this._created) return false;
      let t2 = yield this._sendMessage(`stateMachineLoad`, {
        instanceId: this._id,
        stateMachineId: e5
      });
      return yield this._updateDotLottieInstanceState(), t2;
  ...
  stateMachineLoadData(e5) {
    return __async(this, null, function* () {
      if (!this._created) return false;
      let t2 = yield this._sendMessage(`stateMachineLoadData`, {
        instanceId: this._id,
        stateMachineData: e5
      });
      return yield this._updateDotLottieInstanceState(), t2;
  ...
  stateMachineStart() {
    return __async(this, null, function* () {
      if (!this._created) return false;
      let e5 = yield this._sendMessage(`stateMachineStart`, {
        instanceId: this._id
      });
      return e5 && (this._setupStateMachineListeners(), yield this._updateDotLottieInstanceState()), e5;
    });
  }
  stateMachineStop() {
    return __async(this, null, function* () {
      return this._created ? (this._cleanupStateMachineListeners(), this._sendMessage(`stateMachineStop`, {
        instanceId: this._id
      })) : false;
    });
  }
  stateMachineSetNumericInput(e5, t2) {
    return __async(this, null, function* () {
      return this._created ? this._sendMessage(`stateMachineSetNumericInput`, {
        instanceId: this._id,
        name: e5,
        value: t2
      }) : false;
  ...
  stateMachineSetBooleanInput(e5, t2) {
    return __async(this, null, function* () {
      return this._created ? this._sendMessage(`stateMachineSetBooleanInput`, {
        instanceId: this._id,
        name: e5,
        value: t2
      }) : false;
  ...
  stateMachineSetConfig(e5) {
    return __async(this, null, function* () {
      this._created && this._sendMessage(`stateMachineSetConfig`, {
        instanceId: this._id,
        config: e5
      });
    });
  ...
  stateMachineSetStringInput(e5, t2) {
    return __async(this, null, function* () {
      return this._created ? this._sendMessage(`stateMachineSetStringInput`, {
        instanceId: this._id,
        name: e5,
        value: t2
      }) : false;
  ...
  stateMachineGetNumericInput(e5) {
    return __async(this, null, function* () {
      if (this._created) return this._sendMessage(`stateMachineGetNumericInput`, {
        instanceId: this._id,
        name: e5
      });
    });
  ...
  stateMachineGetBooleanInput(e5) {
    return __async(this, null, function* () {
      if (this._created) return this._sendMessage(`stateMachineGetBooleanInput`, {
        instanceId: this._id,
        name: e5
      });
    });
  ...
  stateMachineGetStringInput(e5) {
    return __async(this, null, function* () {
      if (this._created) return this._sendMessage(`stateMachineGetStringInput`, {
        instanceId: this._id,
        name: e5
      });
    });
  ...
  stateMachineGetInputs() {
    return __async(this, null, function* () {
      if (this._created) return this._sendMessage(`stateMachineGetInputs`, {
        instanceId: this._id
      });
    });
  }
  stateMachineFireEvent(e5) {
    return __async(this, null, function* () {
      this._created && this._sendMessage(`stateMachineFireEvent`, {
        instanceId: this._id,
        name: e5
      });
    });
  ...
  stateMachineGetStatus() {
    return __async(this, null, function* () {
      return this._created ? this._sendMessage(`stateMachineGetStatus`, {
        instanceId: this._id
      }) : ``;
    });
  }
  stateMachineGetCurrentState() {
    return __async(this, null, function* () {
      return this._created ? this._sendMessage(`stateMachineGetCurrentState`, {
        instanceId: this._id
      }) : ``;
    });
  }
  stateMachineGetActiveId() {
    return __async(this, null, function* () {
      return this._created ? this._sendMessage(`stateMachineGetActiveId`, {
        instanceId: this._id
      }) : ``;
    });
  }
  stateMachineOverrideState(e5, t2 = false) {
    return __async(this, null, function* () {
      return this._created ? this._sendMessage(`stateMachineOverrideState`, {
        instanceId: this._id,
        state: e5,
        immediate: t2
      }) : false;
  ...
  stateMachineGet(e5) {
    return __async(this, null, function* () {
      return this._created ? this._sendMessage(`stateMachineGet`, {
        instanceId: this._id,
        stateMachineId: e5
      }) : ``;
    });
  ...
  stateMachineGetListeners() {
    return __async(this, null, function* () {
      return this._created ? this._sendMessage(`stateMachineGetListeners`, {
        instanceId: this._id
      }) : [];
    });
  }
  stateMachinePostClickEvent(e5, t2) {
    return __async(this, null, function* () {
      if (this._created) return this._sendMessage(`stateMachinePostClickEvent`, {
        instanceId: this._id,
        x: e5,
        y: t2
      });
  ...
  stateMachinePostPointerUpEvent(e5, t2) {
    return __async(this, null, function* () {
      if (this._created) return this._sendMessage(`stateMachinePostPointerUpEvent`, {
        instanceId: this._id,
        x: e5,
        y: t2
      });
  ...
  stateMachinePostPointerDownEvent(e5, t2) {
    return __async(this, null, function* () {
      if (this._created) return this._sendMessage(`stateMachinePostPointerDownEvent`, {
        instanceId: this._id,
        x: e5,
        y: t2
      });
  ...
  stateMachinePostPointerMoveEvent(e5, t2) {
    return __async(this, null, function* () {
      if (this._created) return this._sendMessage(`stateMachinePostPointerMoveEvent`, {
        instanceId: this._id,
        x: e5,
        y: t2
      });
  ...
  stateMachinePostPointerEnterEvent(e5, t2) {
    return __async(this, null, function* () {
      if (this._created) return this._sendMessage(`stateMachinePostPointerEnterEvent`, {
        instanceId: this._id,
        x: e5,
        y: t2
      });
  ...
  stateMachinePostPointerExitEvent(e5, t2) {
    return __async(this, null, function* () {
      if (this._created) return this._sendMessage(`stateMachinePostPointerExitEvent`, {
        instanceId: this._id,
        x: e5,
        y: t2
      });
  ...
  _onClick(e5) {
    let t2 = G(e5);
    t2 && this._sendMessage(`stateMachinePostClickEvent`, {
      instanceId: this._id,
      x: t2.x,
      y: t2.y
    });
  ...
  _onPointerUp(e5) {
    let t2 = G(e5);
    t2 && this._sendMessage(`stateMachinePostPointerUpEvent`, {
      instanceId: this._id,
      x: t2.x,
      y: t2.y
    });
  ...
  _onPointerDown(e5) {
    let t2 = G(e5);
    t2 && this._sendMessage(`stateMachinePostPointerDownEvent`, {
      instanceId: this._id,
      x: t2.x,
      y: t2.y
    });
  ...
  _onPointerMove(e5) {
    let t2 = G(e5);
    t2 && this._sendMessage(`stateMachinePostPointerMoveEvent`, {
      instanceId: this._id,
      x: t2.x,
      y: t2.y
    });
  ...
  _onPointerEnter(e5) {
    let t2 = G(e5);
    t2 && this._sendMessage(`stateMachinePostPointerEnterEvent`, {
      instanceId: this._id,
      x: t2.x,
      y: t2.y
    });
  ...
  _onPointerLeave(e5) {
    let t2 = G(e5);
    t2 && this._sendMessage(`stateMachinePostPointerExitEvent`, {
      instanceId: this._id,
      x: t2.x,
      y: t2.y
    });
  ...
  _setupStateMachineListeners() {
    return __async(this, null, function* () {
      if (s && this._canvas instanceof HTMLCanvasElement && this.isLoaded) {
        let e5 = yield this._sendMessage(`stateMachineGetListeners`, {
          instanceId: this._id
        });
...
//# sourceMappingURL=@lottiefiles_dotlottie-web.js.map
